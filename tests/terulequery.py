...
from .test_context.span.indexed_terulequery import TERuleQueryIndexed as TERuleQuery
...
class TERuleQueryTest(mixins.ValidateRule, unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.p = SELinuxPolicy("terulequery.conf")
...
class TERuleQueryXperm(mixins.ValidateRule, unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.p = SELinuxPolicy("terulequery2.conf")
